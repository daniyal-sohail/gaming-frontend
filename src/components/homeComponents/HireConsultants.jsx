            ...
            <div className="max-w-7xl mx-auto px-4">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="lg:flex lg:justify-end">
                        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-6 hover:bg-white/10 hover:border-white/20 hover:shadow-[inset_0_1px_0_0_rgba(255,255,255,0.1),0_8px_32px_rgba(0,0,0,0.3)] transition-all duration-300 max-w-sm w-full">
                            ...
                            <div className="mt-6 pt-4 border-t border-white/10">
                                <button className="w-full py-4 px-6 rounded-xl font-semibold text-base transition-all duration-300 cursor-pointer bg-gradient-to-r from-amber-500 to-orange-600 text-white hover:from-amber-600 hover:to-orange-700 hover:shadow-lg hover:shadow-amber-500/25 hover:-translate-y-0.5">
                                    View Profile
                                </button>
                            </div>
                        </div>
