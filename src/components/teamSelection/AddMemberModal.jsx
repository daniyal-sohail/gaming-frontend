...
export default function AddMemberModal({ teamId, isOpen, onClose }) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
            <div className="bg-[#121212] border border-gray-800 rounded-2xl w-full max-w-4xl max-h-[90vh] overflow-y-auto">
                {/* Header */}
                <div className="sticky top-0 bg-[#121212] border-b border-gray-800 px-6 py-4 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-400">Select a consultant from recommendations</p>
                        </div>
                    </div>
                    <button
                        onClick={() => {
                            ...
                            <div className="space-y-3 max-h-96 overflow-y-auto">
                                {filteredConsultants.length === 0 ? (
                                    <div className="text-center py-12">
                                        ...
                                        <p className="text-gray-400">No consultants found</p>
                                    </div>
                                ) : (
...
function ConsultantSelectCard({ consultant, onSelect }) {
    ...
    return (
        <div
            onClick={onSelect}
            className="p-4 bg-[#0d0d0d] border border-gray-800 rounded-xl hover:border-primary/50 transition-all cursor-pointer group"
        >
            <div className="flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                    ...
                    <p className="text-sm text-gray-400 mb-2">{consultant.title || "Consultant"}</p>
