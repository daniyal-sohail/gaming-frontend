    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
            <div className="bg-[#121212] border border-gray-800 rounded-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
                {/* Header */}
                <div className="sticky top-0 bg-[#121212] border-b border-gray-800 px-6 py-4 flex items-center justify-between z-10">
                    <div className="flex items-center gap-3">
                        <div className="w-10 h-10 bg-primary/10 rounded-xl flex items-center justify-center">
                            <UserPlus className="w-5 h-5 text-primary" />
                        </div>
                        <div>
                            <h2 className="text-xl font-bold text-white">Add to Team</h2>
                            <p className="text-sm text-gray-400">Select a team to add this consultant</p>
                        </div>
                    </div>
                    <button
                        onClick={() => {
                ...
                <form onSubmit={handleSubmit} className="p-6">
                    ...
                    {loadingTeams ? (
                        <div className="py-8 text-center">
                            ...
                            <p className="text-gray-400 text-sm">Loading your teams...</p>
                        </div>
                        ...
                        <div className="py-8 text-center">
                            ...
                            <h3 className="text-lg font-semibold text-white mb-2">No Available Teams</h3>
